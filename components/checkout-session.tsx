...
export function CheckoutSession({customerDetails} : Props) {
  ...
  if (!customerDetails) {
    return (
      <>
        ...
        <h1 className="mt-4 text-2xl font-bold tracking-tight text-red-400 sm:text-3xl">
  ...
  return (
    <>
      ...
      <h1 className="mt-4 text-2xl font-bold tracking-tight text-lime-500 dark:text-lime-400 sm:text-3xl">
        Order Successful!
      </h1>
      <h3 className="mt-8 text-base leading-7">
