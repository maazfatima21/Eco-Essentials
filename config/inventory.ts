...
export const inventory: InventoryProduct[] = [
  ...
  {
    id: "0656557d-529b-4912-94f5-cd31f9e6bdfb",
    sku: "plant_based_cleaners_1",
    name: "Plant Based Cleaners",
    description: `Eco-friendly plant-based cleaning products that are safe for your family and the environment. Our line of natural cleaners removes tough stains without harmful chemicals.`,
    price: 89900,
    image:
      "https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/plant-cleaners-1.jpg",
    images: [
      "https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/plant-cleaners-1.jpg",
    ],
    categories: ["cleaners"],
